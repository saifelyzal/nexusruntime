...
const docTemplate = `{
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/admin.providerCredentialTypeResponse"
                            }
                        }
                    },
                    "401": {
        ...
        "/v1/conversations/{id}/items": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Return items after this item ID",
                        "name": "after",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/core.ConversationItemListResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/core.ConversationItemCreateRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/images/edits": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "file",
                        "description": "Source image to edit (single-image form; gpt-image-1 and DALL·E 2). At least one of image or image[] is required",
                        "name": "image",
                        "in": "formData"
                    },
                    {
                        "type": "file",
                        "description": "Repeatable field carrying several source images (gpt-image-1, up to 16). At least one of image or image[] is required",
                        "name": "image[]",
                        "in": "formData"
                    },
                    {
        ...
        "/v1/realtime/translations": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Translation model that owns the session",
                        "name": "model",
                        "in": "query",
                        "required": true
                    },
        ...
        "/v1/realtime/translations/calls": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Translation model that owns the session (required for raw SDP offers)",
                        "name": "model",
                        "in": "query"
                    },
                    {
        ...
        "/v1/realtime/translations/client_secrets": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Realtime translation session config carrying session.model",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/versioncheck.Status"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "admin.providerCredentialFieldResponse": {
            "type": "object",
            "properties": {
                "advanced": {
                    "description": "Advanced marks a field most operators leave at its default for this\nprovider type.",
                    "type": "boolean"
                },
                "name": {
                    "type": "string"
        ...
        "admin.providerCredentialTypeResponse": {
            "type": "object",
            "properties": {
                "default_base_url": {
                    "type": "string"
                ...
                "fields": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/admin.providerCredentialFieldResponse"
                    }
                },
                "type": {
                    "type": "string"
        ...
        "core.ConversationItemCreateRequest": {
            "type": "object",
            "required": [
                "items"
            ],
        ...
        "core.ConversationItemListResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
