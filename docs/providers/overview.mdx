...
- **Model categories (chat vs embeddings vs audio)** — a model's category comes
  ...
  affect dashboard grouping only; `/v1/embeddings`
...
- **Vendor members are not stripped.** Groq's `x_groq` and its
  ...
  code. See [ADR-0011](https://github.com/saifelyzal/nexusruntime/blob/main/docs/adr/0011-field-forwarding-on-translated-paths.md).
